...
def get_params():
    params = {
        'weight': 'weights/up.pt',  # select your heatmap weights
        'device': 'cuda:0',
        'method': 'GradCAM', # select method GradCAMPlusPlus, GradCAM, XGradCAM, EigenCAM, HiResCAM, LayerCAM, RandomCAM, EigenGradCAM
        'layer': [20, 22, 24, 26],
        # 'layer': [15, 19, 22, 25],
...
# need install grad-cam==1.4.8

if __name__ == '__main__':
    model = rtdetr_heatmap(**get_params())
    # model(r'/home/hjj/Desktop/dataset/dataset_voc/images', 'result')
    model(r'C:/Users/rain/Desktop/test', 'result')

    # model(r'/home/hjj/Desktop/dataset/dataset_voc/images/00001111.png', 'result') # 指定对某一个单张图片输出热力图